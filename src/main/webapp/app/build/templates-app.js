angular.module('templates-app', ['about/about.tpl.html', 'account/login.tpl.html', 'account/register.tpl.html', 'account/search.tpl.html', 'home/home.tpl.html', 'loan/manage-loans.tpl.html']);
...
angular.module("account/search.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/search.tpl.html",
    ...
    "            <td>{{account.name}}</td>\n" +
    "            <td>\n" +
    "                <a ui-sref=\"manageLoans({accountId:account.rid})\" class=\"btn btn-large btn-default\">\n" +
    "                    Manage\n" +
    "                </a>\n" +
    "            </td>\n" +
    "        </tr>\n" +
...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    "<div class=\"jumbotron\">\n" +
    "  <h1>microlending app</h1>\n" +
    "\n" +
    "  <p class=\"lead\">\n" +
    "    With microlending app you can loan money really easy!\n" +
    "  </p>\n" +
    "<ul>\n" +
    ...
    "  </li>\n" +
    "  <li ng-show=\"isLoggedIn()\">\n" +
    "    <a href ui-sref=\"manageLoans({accountId:account.rid})\">\n" +
    "      Manage Loans\n" +
    "    </a>\n" +
    "  </li>\n" +
    "  <li ng-show=\"false\">\n" +
...
angular.module("loan/manage-loans.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("loan/manage-loans.tpl.html",
